...
export default function Orderride() {
  ...
  const options :DropdownOption[] = [
    { value: 'Signin', label: 'Home', image: require('../../assets/images/home.png') },
    { value: 'Signup', label: 'Profile', image: require('../../assets/images/user.png') },
    { value: 'Signup', label: 'Add new Ride', image: require('../../assets/images/addride.png') },
    { value: 'Signup', label: 'Find a ride', image: require('../../assets/images/searchride.png') },
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`http://localhost:5000/ride/${id}`);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.box}>
        ...
        <TouchableOpacity style={styles.button}  onPress={() => router.push('/Signin')}>
          <Text style={styles.buttonText}>Order your Ride!</Text>
        </TouchableOpacity>
        </View>
      </View>
